...
Provide comprehensive patterns for implementing shadcn/ui components in Next.js 16 applications. Focus on composition over props, accessibility-first design, and type-safe integration with TanStack Query and react-hook-form.
...
- Connecting forms to API routes and TanStack Query mutations
...
shadcn/ui components are copied into the project, not imported as dependencies. Customize directly in `components/ui/` (no `src/` directory in this project).
