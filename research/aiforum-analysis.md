...
*Full text extracted via HYPNOS pdfplumber: `data/raw/aiforum-productivity-sep2024-extracted.md`*
*Academic Lead: Dr Andrew Lensen (VUW), Partnership: Callaghan Innovation*
...
- **62%** reported operational cost savings
- Strong correlation between AI spend and financial benefits (Spearman's r = 0.83)
- **52%** reported initial setup costs; **62%** reported ongoing costs
- Costs generally on lower end, except some high initial setup costs

### Efficiency
- **96%** of respondents indicated AI has made workers more efficient

### Job Displacement
- **Only 8%** reported that AI had replaced employees
- Those who did reported **minimal displacement (5-10%)**
- Nearly half reported AI **created new career opportunities**

### Top Use Cases
| Use Case | % of AI deployment |
|---|---|
| Marketing | 16% |
| Administration | 13.8% |
| Design | 9.6% |
...
| ANZSIC Division | Responses | % |
|---|---|---|
| Education and Training | 52 | 22.4% |
| Information, Media and Telecommunications | 28 | 12.1% |
| Professional, Scientific and Technical Services | 26 | 11.2% |
| Public Administration and Safety | 21 | 9.1% |
| Financial and Insurance Services | 19 | 8.2% |
| Health Care and Social Assistance | 17 | 7.3% |
| Construction | 11 | 4.7% |
| Other Services | 10 | 4.3% |
| Administrative and Support Services | 9 | 3.9% |
| Retail Trade | 7 | 3.0% |
| Manufacturing | 6 | 2.6% |
| Electricity, Gas, Water and Waste Services | 5 | 2.2% |
| Transport, Postal and Warehousing | 5 | 2.2% |
| Agriculture, Forestry and Fishing | 5 | 2.2% |
| Arts and Recreation | 4 | 1.7% |
...
- **B12 (barriers):** Skills and expertise are the primary barrier (consistent with Treasury, OECD, FMA findings)
- **C16 (displacement):** Only 8% of orgs experienced displacement; those who did = 5-10% of workforce affected. This is the figure cited by RBNZ.
- **C18 (new job creation):** Nearly half of respondents report AI creating new career opportunities
- **B10 (types of AI):** GenAI dominant (55%), ML (19.5%), use concentrated in marketing/admin/design
