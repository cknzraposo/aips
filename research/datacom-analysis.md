...
*Full text extracted via HYPNOS pdfplumber: `data/raw/datacom-state-of-ai-2024-extracted.md`*
*Research by: Curia Market Research*
...
- **29%** not using AI at all
- **5%** unsure
- Of those using AI: **57% introduced it within the last year**, 31% 1-2 years ago
- Of non-users: **25% plan to adopt within 1 year**, 33% have **no plans**

### Primary Uses of AI
| Use Case | % |
|---|---|
| Big data analytics and synthesising insights | 24% |
| Automation of repetitive tasks and processes | 17% |
| Improving customer experiences | 15% |
| Innovation and strategy development | 5% |
| Improving employee experiences | 5% |
| Workflow automation and optimisation (productivity) | 8% |
| Other (code writing, compliance, presentations, documentation) | 26% |

### Barriers to Adoption (among non-users)
| Barrier | % |
|---|---|
| Waiting for AI expertise to become available | 43% |
| No clear use case | 29% |
| Waiting for tech to mature | 27% |
| Don't understand AI | 11% |
| No interest at senior level | 3% |

**97% of non-adopters** said it was NOT due to lack of interest or appetite at senior level.

### Governance Gap
| Governance Measure | In Place (%) |
|---|---|
| Staff policy around AI | 48% |
| Staff awareness training | 33% |
| Audit assurance & governance | 13% |
...
| AI bias | 46% |
| Safety | 39% |
| Ethical questions | 36% |
| Cost | 21% |

### Economic Outlook
- **71%** believe AI adoption will drive economic advantage / new revenue for NZ
- **44%** believe NZ is well-placed to adapt to AI revolution and keep pace globally
- **34%** believe NZ is NOT well-placed

### Workforce
- **83%** believe AI will impact operations and workforce structure
- **39%** of AI-using orgs have dedicated skilled resources to manage AI
- **50%** do not
- **65%** of planned adopters will dedicate skilled resources
- **76%** do NOT require new hires to have AI experience
